  ...
  return (
    <header className="absolute inset-x-0 top-0 z-40 bg-transparent">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-4 py-4 sm:px-6 lg:px-10">
        <Link
          href="/"
          className="flex items-center gap-3 text-sm font-black uppercase tracking-[0.45em] text-[#f5e6a8] transition hover:text-[#ff0095]"
        >
          <Image
            src="/TCELogo.png"
        ...
        <nav className="hidden items-center gap-1 rounded-full border border-white/8 bg-[#050505]/70 backdrop-blur-xl px-3 py-2 lg:flex">
          {navItems.map((item) =>
